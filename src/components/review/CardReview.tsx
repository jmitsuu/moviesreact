...
export function CardReview({
  ...
  return (
    <button className={` absolute box-content transition-all m-auto`}>
      <div
        className={`relative  flex w-[500px] ${isHovered ? 'blur-none z-50' : ''}`}
        onMouseEnter={() => {
          setIsHovered(true)
        }}
        onMouseLeave={() => {
      ...
      >
        {url && (
          ...
          >
            <div
              className={`absolute top-0 flex justify-center flex-col group-hover:z-50 h-full w-44 bg-black/90 p-2`}
            >
