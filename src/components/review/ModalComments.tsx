 ...
 return (
  ...
  <Dialog open={ctrlComments}>
      ...
      >
       ...
       />
       {errors.inputDescription && <span className="text-xs">Campo Obrigatório</span>}     
       {star !== 0 ? <span>Sua avaliação: {star}</span>:(
   ...
   <IoStar onClick={()=> setStar(index +1)} className="flex cursor-pointer text-xl m-1 hover:border border-yellow-500 rounded text-yellow-500"  key={el} />
