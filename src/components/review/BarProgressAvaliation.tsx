...
export function BarProgressAvaliation({ total }: typeBar) {
  if (total.includes('Não existem dados para retornar'))
    return <div>Sem estrelas até o momento</div>
    ...
    <>
      {five ? (
        <div className="flex items-center gap-2 justify-between">
          {' '}
          <span className="text-yellow-500 flex  ">{utilStars(5)}</span>{' '}
      ...
      {four ? (
        <div className="flex items-center gap-2 justify-between">
          {' '}
          <span className="text-yellow-500 flex  ">{utilStars(4)}</span>{' '}
      ...
      {three ? (
        <div className="flex items-center gap-2 justify-between">
          {' '}
          <span className="text-yellow-500 flex  ">{utilStars(3)}</span>{' '}
      ...
      {two ? (
        <div className="flex items-center gap-2 justify-between">
          {' '}
          <span className="text-yellow-500 flex  ">{utilStars(2)}</span>{' '}
      ...
      {one ? (
        <div className="flex items-center gap-2 justify-between">
          {' '}
          <span className="text-yellow-500 flex  ">{utilStars(1)}</span>{' '}
